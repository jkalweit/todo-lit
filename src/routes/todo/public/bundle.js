...
`;
	...
	*/
	...
	var apiKeyvalClient = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.createApi = (endpointUrl) => {
	    ...
	    const putItem = (item) => {
	        item.id = item.id || utils.guidShort();
	...
	unwrapExports(apiKeyvalClient);
	var apiKeyvalClient_1 = apiKeyvalClient.handleError;
	var apiKeyvalClient_2 = apiKeyvalClient.handleJsonResponse;
	var apiKeyvalClient_3 = apiKeyvalClient.sendJson;
	var apiKeyvalClient_4 = apiKeyvalClient.createApi;

	var store = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	const todosApi = apiKeyvalClient.createApi("./api/todo");
	exports.Actions = {
	    Todos: Object.assign({}, todosApi),
	};
	//# sourceMappingURL=data:application/json;base64,
	});

	unwrapExports(store);
	var store_1 = store.Actions;

	var todo = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.TodosList = (todos) => {
	    const deleteTodo = (todo) => {
	        store.Actions.Todos.deleteItem(todo);
	    };
	    return utilsBrowser.html `
        ${utilsBrowser.repeat(todos, (x) => x.id, (x) => utilsBrowser.html `
            <div class="row">
                <div class="w4">${utilsBrowser.normalizedDate(x.createdAt)}</div>
	...
	exports.Todos = () => {
	    const NewTodo = () => {
	        const inputRef = utilsBrowser.elementRef();
	        const addTodo = () => {
	            const text = inputRef.get().value;
	            store.Actions.Todos.putItem({
	                createdAt: new Date().toISOString(),
	                id: utils.guidShort(),
	                text,
	            }).then((added) => {
	                utilsBrowser.log("Added Todo:", added);
	                refresh();
	            });
	        };
	        return utilsBrowser.html `
	    ...
	    const listRef = utilsBrowser.elementRef();
	    const refresh = () => {
	        store.Actions.Todos.getAll().then((todos) => {
	            const arr = utils.toArray(todos);
	            utilsBrowser.render(exports.TodosList(arr), listRef.get());
	        });
	    };
	    refresh();
	    return utilsBrowser.html `
	...
	unwrapExports(todo);
	var todo_1 = todo.TodosList;
	var todo_2 = todo.Todos;
	...
	const Main = () => utilsBrowser.html `
    ${nav.Nav}
    <h1>Todo</h1>
    ${todo.Todos()}
`;
	page.base(routeBase);
	page("/", () => utilsBrowser.render(Main(), mainDiv));
	page("*", (ctx) => {
	    utilsBrowser.log("ERROR: Page Not Found", ctx);
	    utilsBrowser.render(utilsBrowser.html `<h3>Error [client]: Page Not Found</h3>`, mainDiv);
	});
	page.start();
